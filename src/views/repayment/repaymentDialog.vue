    ...
    >
      <div>
        <el-card class="box-card">
          ...
          <el-row>
            <el-col :span="4">
              <div class="grid-content bg-purple">银行账户姓名</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content">{{ clientLoadInfo.bankCardName }}</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">还款银行名称</div>
            </el-col>
            <el-col :span="4">
            ...
            <el-col :span="4">
              <div class="grid-content bg-purple">还款银行卡号</div>
            </el-col>
            <el-col :span="4">
          ...
          <el-row>
            ...
            <el-col :span="4">
              <div class="grid-content">{{ clientLoadInfo.debtAmt / 100 }}</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">借款利率</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content">{{ clientLoadInfo.debtInterest }}</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">借款期限</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content">{{ clientLoadInfo.debtLimit }}</div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="4">
              <div class="grid-content bg-purple">起息日</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content">{{ clientLoadInfo.startDate }}</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">截止日</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content">{{ clientLoadInfo.endDate }}</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">客户姓名</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content">{{ clientLoadInfo.clientName }}</div>
            </el-col>
          </el-row>
        </el-card>
            ...
            <el-table-column label="操作">
              <template slot-scope="{ row }">
                <el-button
                  type="primary"
                  v-if="
                    row.repayState !== 'BACKED' &&
                      row.repayState !== 'OVERDUE_BACKED' &&
                      row.repayState !== 'EARLY_BACKED'
                  "
                  @click="confirmRepayment(row)"
                  >确认还款</el-button
                >
              </template>
            </el-table-column>
